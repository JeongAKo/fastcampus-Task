...
final class CustomCellViewController: UIViewController {
    ...
    private func setupFlowLayout() {
        ...
        layout.scrollDirection = showDirection ? .horizontal : .vertical
    ...
    @objc private func changeCollectionViewDirection(_ sender: Any) {
        ...
        let layout = (collectionView.collectionViewLayout as! UICollectionViewFlowLayout)
        let currenrt = layout.scrollDirection
        layout.scrollDirection = currenrt == .horizontal ? .vertical : .horizontal
