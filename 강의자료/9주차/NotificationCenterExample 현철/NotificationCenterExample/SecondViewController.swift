...
// 보내는 객체에 Notification.Name 타입 속성 지정 (>=4.2 방식) *권장*
extension SecondViewController {
    static var randomeColorNotification: Notification.Name {
...
final class SecondViewController: UIViewController {
    ...
    func addNotificationObserver() {
        ...
        notiCenter.addObserver(
            self,
            selector: #selector(didReceiveRandomColorNotification(_:)),
            name: SecondViewController.randomeColorNotification,
            object: nil
        )
        ...
        notiCenter.addObserver(
            self,
            selector: #selector(didReceivePlusNotification(_:)),
            
            // name 등록 방법 3가지
            // 1) 직접 생성
            // name: Notification.Name("PlusNotification"),
...
//        notiCenter.post(name: .plusNotification, object: nil)
