...
final class ViewController: UIViewController {
    ...
    @IBAction private func triggerTimeIntervalNotification(_ sender: Any) {
        ...
        let timeIntercal = TimeInterval(timeIntervalLabel.text!) ?? 3.0
        notiManger.triggerTimeIntervalNotification(with: notificationTitle, timeInterval:  timeIntercal
        )
    }
