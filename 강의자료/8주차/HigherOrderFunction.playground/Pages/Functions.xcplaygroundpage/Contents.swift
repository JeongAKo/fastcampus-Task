...
var reduceArray = ["1", "2", "3"]

//    .reduce("") {str: String, num: String }
...
/*:
 ...
 ---
 */
// compactMap //numbers.compactMap { $0 >= 0 ? $0 : nil } // [0, 1, 2]


//let containnumbers = numbers
//    .filter { (number) -> Bool in
////        return number.contain(number>0)
//
//}
//print(containnumbers)


// flatMap //let nestedArr = [[1, 2, 3], [1, 5, 99], [1, 1]] // [1, 2, 3, 1 ,5, 99, 1, 1]
let immutableArray2 = nestedArr

for num in immutableArray2 {
    for num2 in num {
