...
let countString = { ( string: String) -> Int in

    return string.count
    
}
print(countString("swift"))


// 2번 문제 예.   5 -> 6

let plusOne = { (num: Int) -> Int in
    return num + 1
}
print(plusOne(5))
...
let multiplyTwoNumbers1 = { (op1: Int, op2: Int) -> Int in
  return op1 * op2
}


let multiplyTwoNumber3: (Int, Int) -> Int = { $0 * $1 }
